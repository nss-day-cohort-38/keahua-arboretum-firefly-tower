...
class BlueJadeVine(ITerrestrial, IFreshwater, Plant):
    ...
    def __init__(self):
      ...
      # but it also says it lives in grasslands, which are labeled as having "No Shade"
      self.tolerate_sun = True 
      # This being set to false by IFreshwater is not true for this plant,
      # if it lives in a swamp?
