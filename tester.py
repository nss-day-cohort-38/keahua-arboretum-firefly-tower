...
animal_classes = [GoldDustDayGecko, HawaiianHappyFaceSpider,
                  Kikakapu, NeneGoose, Opeapea, Pueo, RiverDolphin, Ulae]
plant_classes = [RainbowEucalyptusTree,
                 Silversword, MountainAppleTree, BlueJadeVine]
environment_classes = [Coastline, Forest, Grassland, Mountain, River, Swamp]

names = ["Liam", "Emma", "Noah", "Olivia", "William", "Ava", "James", "Isabella", "Oliver", "Sophia",
         "Benjamin", "Charlotte", "Tegan", "Darby", "Eisley", "Furlough", "Anthony", "Stuck", "Beef"]
